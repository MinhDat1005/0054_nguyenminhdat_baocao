               ...
               <div class="card">
                  <div class="card-header">
                     ...
                     <a href="index.php?option=product" class="btn btn-sm btn-primary mb-2">Tất cả </a> |
                        <a class="btn btn-danger btn-xs mb-2" href="index.php?option=product&cat=trash"><i class="fas fa-trash"></i> Thùng rác</a>
                     </div>
                     <select name="" id="" class="form-control d-inline" style="width:100px;">
                        <option value="">Xoá</option>
                     </select>
                     <button value="submit" class="btn btn-sm btn-success">Áp dụng</button>
                  </div>
                  <div class="card-body">
