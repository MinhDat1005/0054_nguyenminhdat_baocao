            ...
            <section class="content">
               <div class="card">
                  <div class="card-header text-right">
                     ...
                     <button type="submit" class="btn btn-sm btn-success" name="THEMSANPHAM">
                     ...
                     <div class="row">
                        <div class="col-md-9">
                           ...
                           <div class="mb-3">
                              ...
                              <textarea name="detail" placeholder="Nhập chi tiết sản phẩm" rows="3"
                                 class="form-control"></textarea>
                           </div>
                           <div class="mb-3">
                              <label>Description (*)</label>
                              <textarea name="description" placeholder="Nhập chi tiết sản phẩm" rows="3"
                                 class="form-control"></textarea>
                           </div>
                        </div>
                        <div class="col-md-3">
