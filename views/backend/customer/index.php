         ...
         <section class="content">
            <div class="card">
               ...
               <div class="col-md-12 p-2">
                  <a href="index.php?option=customer" class="btn btn-sm btn-primary mb-2">Tất cả </a> |
                  <a class="btn btn-danger btn-xs" href="index.php?option=customer&cat=trash"><i class="fas fa-trash"></i> Thùng rác</a>
               </div>
               </div>
               <div class="card-body">
