   ...
   <section class="hdl-maincontent py-2">
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-6">
               <h1 class="text-info"><?=$pro->name;?></h1>
               <h3 class="fs-5"> 
                  <?=MyClass::word_limit($pro->detail,30);?>
               </h3>
               <h6 class="text-secondary my-2 "><del>Giá gốc: <?=number_format($pro->price);?>đ</del></h6>
               <h4 class="text-danger">Khuyến mãi: <?=number_format($pro->pricesale);?>đ</h4>
...
<script>
   function addcart(id)
   {
      ...
      //Thêm vào giỏ hàng JQUERY
      $.ajax({url: "index.php?option=cart&addcart=true",
         type: "GET",
         data: {
            id:id,
            qty:qty,
