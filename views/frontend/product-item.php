<div class="product-item border">
   ...
   <h2 class="product-item-name text-main text-center fs-5 py-1">
      <a class="text-primary" href="index.php?option=product&slug=<?= $product->slug;?>"><?= $product->name;?></a>
   </h2>
   <h3 class="product-item-price fs-6 p-2 d-flex">
      <div class="flex-fill"><del><?=number_format( $product->price);?>đ</del></div>
      <div class="flex-fill text-end text-danger"><?=number_format( $product->pricesale);?>đ</div>
   </h3>
</div>