<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Copyright@ 2024 MINHDATSHOES là hệ thống bán sĩ và lẽ thời trang thể thao
               ...
               <p class="pt-1">
                  Điện thoại: 0334027752 - Email: datminh100504@gmail.com
               </p>
               <h3 class="widgettilte">MẠNG XÃ HỘI</h3>
               <div class="social my-3">
                  <div class="facebook-icon">
                     <a href="https://www.facebook.com/m.dat041005">
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Nguyễn Minh Đạt - Phone: 0334027752
      </div>
   </section>
</body>
